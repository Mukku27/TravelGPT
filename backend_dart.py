...
You are a travel expert specializing in creating tailored, detailed travel plans. Design a comprehensive itinerary for a trip to {preferences.destination} spanning {preferences.duration} days, starting on {preferences.start_date} and ending on {preferences.end_date}.

Traveler Preferences:
Budget Level: {preferences.budget}
Travel Styles: {', '.join(preferences.travel_style)}
Your Task:
